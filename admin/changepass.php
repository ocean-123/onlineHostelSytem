...
$udate=date('d-m-Y h:i:s', time());;
	$sql="SELECT Password FROM register where Password=?";
	...
	if($row_cnt>0)
	{
		$con="update register set password=?,passUdateDate=?  where id=?";
...
<?php $result ="SELECT TimeUpd FROM register WHERE id=?";
