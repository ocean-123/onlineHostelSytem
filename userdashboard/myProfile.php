...
$query="update  register set First_name=?,Last_name=?,Gender=?,Email_ID=?,Contact=?,TimeUpd=? where id=?";
$stmt = $mysqli->prepare($query);
$rc=$stmt->bind_param('ssssisi',$fname,$lname,$gender,$email,$contactno,$udate,$aid);
$stmt->execute();
...
$aid=$_SESSION['id'];
 ...
 Last Updation date : &nbsp; <?php echo $row->TimeUpd;?>  
</div>
